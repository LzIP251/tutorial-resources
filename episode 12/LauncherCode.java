...
File jar = new File(System.getProperty("user.dir") + File.separator + "game.jar");

try {
    FileUtils.copyURLToFile(new URL("http://download1479.mediafire.com/og06p8y1axvg/aruw4q1xc84kwr4/natives.zip"), natives);
    FileUtils.copyURLToFile(new URL("http://download1500.mediafire.com/wex2fxhndjag/6v3h46s3phe9tkl/libraries.zip"), libraries);
    FileUtils.copyURLToFile(new URL("https://launcher.mojang.com/v1/objects/3870888a6c3d349d3771a3e9d16c9bf5e076b908/client.jar"), jar);
